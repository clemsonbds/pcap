...
import format.OverlapLengthRecordReader;
 ...
 * conf.setInt(OverlapLengthInputFormat.FIXED_RECORD_LENGTH, recordLength);
 * <br><br>
 * @see OverlapLengthRecordReader
 */
@InterfaceAudience.Public
@InterfaceStability.Stable
public class OverlapLengthInputFormat
    extends FileInputFormat<LongWritable, BytesWritable> {

  public static final String FIXED_RECORD_LENGTH =
      "overlaplengthinputformat.record.length"; 
  public static final String OVERLAP_LENGTH = 
      "overlaplengthinputformat.overlap.length";
